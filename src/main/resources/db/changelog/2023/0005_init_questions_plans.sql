...
insert into questions(id, text, level_id, category_id) values (nextval('s_questions'), 'What the Index Only Scan does?', 1, currval('s_categories'));
insert into answers(id, text, question_id) values (nextval('s_answers'), 'Read the whole index', currval('s_questions'));
insert into answers(id, text, question_id) values (nextval('s_answers'), 'Go from the root to the only accepted value, if any', currval('s_questions'));
insert into answers(id, text, question_id) values (nextval('s_answers'), 'Go from the root to the first leaf node with accepted value, than walk through leafs until condition is false without following table access', currval('s_questions'));
update questions set correct_answer_id = currval('s_answers') where id = currval('s_questions');
...
insert into questions(id, text, level_id, category_id) values (nextval('s_questions'), 'What the Bitmap Heap Scan does?', 1, currval('s_categories'));
insert into answers(id, text, question_id) values (nextval('s_answers'), 'Read the inner structures to access index pages more efficiently', currval('s_questions'));
insert into answers(id, text, question_id) values (nextval('s_answers'), 'Read in-memory bitmap to combine two indexes', currval('s_questions'));
...
insert into questions(id, text, level_id, category_id) values (nextval('s_questions'), 'What the CTE Scan does?', 1, currval('s_categories'));
...
insert into questions(id, text, level_id, category_id) values (nextval('s_questions'), 'What the Custom Scan does?', 1, currval('s_categories'));
...
insert into questions(id, text, level_id, category_id) values (nextval('s_questions'), 'What the Foreign Scan does?', 1, currval('s_categories'));
insert into answers(id, text, question_id) values (nextval('s_answers'), 'There is no such operation', currval('s_questions'));
insert into answers(id, text, question_id) values (nextval('s_answers'), 'Data access through custom scan provider', currval('s_questions'));
insert into answers(id, text, question_id) values (nextval('s_answers'), 'Data access through foreign data wrapper', currval('s_questions'));
update questions set correct_answer_id = currval('s_answers') where id = currval('s_questions');
...
insert into questions(id, text, level_id, category_id) values (nextval('s_questions'), 'What the Function Scan does?', 1, currval('s_categories'));
insert into answers(id, text, question_id) values (nextval('s_answers'), 'There is no such operation', currval('s_questions'));
insert into answers(id, text, question_id) values (nextval('s_answers'), 'Data access through functional index', currval('s_questions'));
insert into answers(id, text, question_id) values (nextval('s_answers'), 'Data access through custom scan provider', currval('s_questions'));
...
insert into questions(id, text, level_id, category_id) values (nextval('s_questions'), 'What the Subquery Scan does?', 1, currval('s_categories'));
insert into answers(id, text, question_id) values (nextval('s_answers'), 'There is no such operation', currval('s_questions'));
...
insert into questions(id, text, level_id, category_id) values (nextval('s_questions'), 'What the Table Sample Scan does?', 1, currval('s_categories'));
insert into answers(id, text, question_id) values (nextval('s_answers'), 'There is no such operation', currval('s_questions'));
...
insert into questions(id, text, level_id, category_id) values (nextval('s_questions'), 'What the Tid Scan does?', 1, currval('s_categories'));
insert into answers(id, text, question_id) values (nextval('s_answers'), 'There is no such operation', currval('s_questions'));
...
insert into questions(id, text, level_id, category_id) values (nextval('s_questions'), 'What the Values Scan does?', 1, currval('s_categories'));
insert into answers(id, text, question_id) values (nextval('s_answers'), 'There is no such operation', currval('s_questions'));
...
insert into questions(id, text, level_id, category_id) values (nextval('s_questions'), 'What the Work Table Scan does?', 1, currval('s_categories'));
insert into answers(id, text, question_id) values (nextval('s_answers'), 'There is no such operation', currval('s_questions'));
