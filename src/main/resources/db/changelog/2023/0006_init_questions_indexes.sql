...
insert into questions(id, text, level_id, category_id) values (nextval('s_questions'), 'Which types of pages hash index has?', 1, currval('s_categories'));
...
insert into questions(id, text, level_id, category_id) values (nextval('s_questions'), 'What an bottom-up index deletion?', 1, currval('s_categories'));
...
insert into questions(id, text, level_id, category_id) values (nextval('s_questions'), 'What an simple index tuple deletion?', 1, currval('s_categories'));
insert into answers(id, text, question_id) values (nextval('s_answers'), 'Operation of index removal, called on drop index', currval('s_questions'));
insert into answers(id, text, question_id) values (nextval('s_answers'), 'Index maintenance operation, performed when tuple deleted from table', currval('s_questions'));
...
insert into questions(id, text, level_id, category_id) values (nextval('s_questions'), 'Does Postgres index NULL values?', 1, currval('s_categories'));
...
insert into questions(id, text, level_id, category_id) values (nextval('s_questions'), 'Does Postgres combine duplicate index keys?', 1, currval('s_categories'));
...
insert into questions(id, text, level_id, category_id) values (nextval('s_questions'), 'Does Postgres allow to keep extra columns, which are doesn''t part of key?', 1, currval('s_categories'));
insert into answers(id, text, question_id) values (nextval('s_answers'), 'No', currval('s_questions'));
